...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		Integer[] vertexDegrees = new Integer[getNumVertices()];
		for (int i=0; i < getNumVertices(); i++) {
			vertexDegrees[i] = getNeighbors(i).size() + getInNeighbors(i).size();
		}
		Arrays.sort(vertexDegrees, Collections.reverseOrder());
		return Arrays.asList(vertexDegrees);
	}
	...
	public static void main (String[] args) {
        ...
        System.out.println("----------------------");
        GraphAdjList testGraph1 = new GraphAdjList();
        GraphLoader.loadGraph("data/graders/mod1/graph1.txt", testGraph1);
        System.out.println(testGraph1);
        System.out.println(testGraph1.degreeSequence());
        System.out.println(testGraph1.getDistance2(5));
